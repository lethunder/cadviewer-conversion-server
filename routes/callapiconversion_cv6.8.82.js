		...
		*/	
        ...
        if (action == "data_extraction"){
            ...
            */
            ...
            if (cvjs_debug) console.log("writeFile="+writeFile);
            if (cvjs_debug) console.log("BEFORE HTTP BRANCH "+contentLocation);
            if (config.cvjs_debug) console.log("1111111111111111");
            if (config.cvjs_debug) console.log(contentLocation);
            // 6.2.69 
            ...
            if (config.cvjs_debug) console.log("22222222222222222");
            if (config.cvjs_debug) console.log(contentLocation);
            ...
            if (contentLocation.indexOf("http:")>-1  || contentLocation.indexOf("https:")>-1){  // download file
                ...
                if (config.cvjs_debug) console.log(contentLocation);
                if (config.cvjs_debug) console.log(tempFileName);
                if (config.cvjs_debug) console.log(newcontentLocation);
